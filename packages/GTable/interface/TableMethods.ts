...
export default interface TableMethods {
     ...
     */
    toggleRowSelection: (row?: BaseTableDataItem, selected?: boolean) => void
    /**
     * 用于多选表格，切换全选和全不选
     */
     ...
     */
    toggleRowExpansion: (row?: BaseTableDataItem, expanded?: boolean) => void
    /**
     * 用于单选表格，设定某一行为选中行，如果调用时不加参数，则会取消目前高亮行的选中状态
     */
    setCurrentRow: (row?: BaseTableDataItem) => void
    /**
